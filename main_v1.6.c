...
int main(int argc, char *argv[]) {
    ...
    // Specifying the audio device to use
    char *pcm_name = "plughw:0,0";  // Specify the correct card and device number
    /* Open the audio device */
    error = snd_pcm_open(&handle, pcm_name, SND_PCM_STREAM_PLAYBACK, 0);
if (error < 0) {
